...
output_file = '/home/afpuertav/mySpace/archivos/fuente_infoso/result_selectra.xlsx'
batch_size = 16
...
# Inicializar modelo
classifier = pipeline("zero-shot-classification", model="Recognai/zeroshot_selectra_small", device=device)
...
df['infoso-selectra'] = all_sources
df['prob-infoso-selectra'] = all_probs
