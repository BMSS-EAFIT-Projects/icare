...
output_file = '/home/afpuertav/mySpace/archivos/fuente_infoso/result_xlm_roberta.xlsx'
batch_size = 16
...
df['infoso-xml-roberta'] = all_sources
df['prob-infoso-xml-roberta'] = all_probs
